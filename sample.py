...
class Model:
    def __init__(self) -> None:
        ...
        self.prompt_template = ChatPromptTemplate.from_template(
            "You are a helpful assistant who responds based on the image. Here is the description of that image: '{image_description}'. {question} Please respond concisely, not more than 4 to 5 lines."
        )
